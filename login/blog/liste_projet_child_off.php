...
$apple->sql='SELECT * FROM `liste_projet` WHERE `liste_projet_id_sha1`="'.$PHP_SELF_strrev_info.'"';
$apple->execution();
...
$apple->sql='SELECT * FROM `liste_projet_child` WHERE `liste_projet_child_sha1`="'.$PHP_SELF_strrev_info.'"';
$apple->execution();
